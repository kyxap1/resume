...
devops:
	...
	@mkdir -p html
	jq -s -f filters/merge.jq --arg role "devops" devops.resume.json companies/*.json skills/_common.json skills/devops.json > html/resume.json
...
devsecops:
	...
	@mkdir -p html
	jq -s -f filters/merge.jq --arg role "devsecops" companies/*.json skills/_common.json skills/devops.json > html/resume.json
